...
export class PostdetailsComponent implements OnInit {
  ...
  constructor(public commentService: CommentService, public voteService: VoteService, public reportS: ReportService , public postService: PostService , private route: ActivatedRoute, @Inject(LOCAL_STORAGE) private storage: WebStorageService, private router: Router) { }
  ...
  addreport() {
    ...
    this.reportS.addreport(this.report , this.post.id_post).subscribe();
  }
